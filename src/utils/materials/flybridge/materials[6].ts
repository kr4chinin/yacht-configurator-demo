...
export const redCarbonMaterial6 = new MeshBasicMaterial({ map: redCarbonTexture })

const sunnyGreenTexture = new TextureLoader().load(Children6.variant2)
export const sunnyGreenMaterial6 = new MeshBasicMaterial({ map: sunnyGreenTexture })
...
export const asphaltGrayMaterial6 = new MeshBasicMaterial({ map: asphaltGrayTexture })

const grayCarbonTexture = new TextureLoader().load(Children6.variant6)
export const grayCarbonMaterial6 = new MeshBasicMaterial({ map: grayCarbonTexture })
